...
/* Coperd: assigned page in the physical address space */
typedef struct PhysPageDesc {
    /* offset in host memory of the page + io_index in the low bits */
    ram_addr_t phys_offset;
    ram_addr_t region_offset; /* Coperd: only useful for IO-pages */
} PhysPageDesc;
...
/* Coperd: physical address space, to understand */
...
#else
/* Coperd: read/write to guest physical memory */
void cpu_physical_memory_rw(target_phys_addr_t addr, uint8_t *buf,
                            int len, int is_write)
{
    int l, io_index;
